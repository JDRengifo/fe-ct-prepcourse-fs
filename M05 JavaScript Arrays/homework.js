...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   nuevaFrase1 = nuevasPalabras.split(',');
   nuevaFrase2 = nuevaFrase1.join('')
   return nuevaFrase2;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   promedio = num / resultadosTest.length;
   return promedio;
}
...
function numeroMasGrande(arrayOfNums) {
   ...
   for (i = 1; i < arrayOfNums.length; i++){
      if (num[i] > num) numeroMayor = num[i]
   };return numeroMayor;
}
